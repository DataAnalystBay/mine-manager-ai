...
export function translateDynamicExecutiveText(
  ...
  if (fleetDetailMatch) {
    return (
      ...
      `тайлант хугацаанд ${fleetDetailMatch[3]} нэгж хувиар сайжирсан байна. ` +
      `Техникийн бэлэн байдал болон ашиглалт нь одоогийн сэргэлтийг дэмжиж байна. ` +
      `Одоогоор техникийн гүйцэтгэлд материаллаг сөрөг зөрүү илрээгүй байна.`
    );
  }
  ...
  if (fleetDetailMatch) {
    return (
      "Техникийн гүйцэтгэл одоогоор зорилтоос дээгүүр байна. " +
      "Энэхүү түвшин тогтвортой хадгалагдаж байгаа эсэхийг баталгаажуулахын тулд " +
      "техникийн бэлэн байдал болон ашиглалтыг үргэлжлүүлэн хянах шаардлагатай."
    );
  }
  ...
  if (fleetDetailMatch) {
    return (
      `Техникийн гүйцэтгэл ${fleetDetailMatch[1]}% байгаа нь ` +
      `${fleetDetailMatch[2]}%-ийн зорилтоос ${fleetDetailMatch[3]} нэгж хувиар доогуур байна. ` +
      `Гэсэн хэдий ч тайлант хугацаанд ${fleetDetailMatch[4]} нэгж хувиар сайжирсан байна.`
    );
  }
  ...
  if (fleetDetailMatch) {
    return (
      "Одоогийн сэргэлтийн чиг хандлага эерэг боловч техникийн гүйцэтгэл " +
      "зорилтоос доогуур хэвээр байна. Хэмжигдэж буй техникийн нөлөөлөгч " +
      "үзүүлэлтүүдийг тогтвортой сайжруулах шаардлагатай."
    );
  }
  ...
  if (fleetDetailMatch) {
    return (
      ...
      `тайлант хугацаанд ${fleetDetailMatch[3]} нэгж хувиар буурсан байна. ` +
...
/* ====================================================
  ...
  if (kpiSummaryMatch) {
    ...
    return (
      `${translatedKpi} зорилтот түвшнээс ` +
      `${kpiSummaryMatch[2]}% доогуур байна. ` +
      `Бодит гүйцэтгэл ${kpiSummaryMatch[3]}, ` +
      `төлөвлөгөө ${kpiSummaryMatch[4]}, ` +
      `өөрөөр хэлбэл төлөвлөгөөний ` +
      `${kpiSummaryMatch[5]}% байна.`
    );
  }
  ...
  if (kpiSummaryMatch) {
    ...
    return (
      `${translatedKpi} зорилтот түвшнээс ` +
      `${kpiSummaryMatch[2]}% дээгүүр байна. ` +
      `Бодит гүйцэтгэл ${kpiSummaryMatch[3]}, ` +
      `төлөвлөгөө ${kpiSummaryMatch[4]}, ` +
      `өөрөөр хэлбэл төлөвлөгөөний ` +
      `${kpiSummaryMatch[5]}% байна.`
  ...
  if (kpiSummaryMatch) {
    ...
    return (
      `${translatedKpi} зорилтот түвшинд яг хүрсэн бөгөөд ` +
      `гүйцэтгэл ${kpiSummaryMatch[2]} байна.`
    );
  }
  ...
  if (kpiSummaryMatch) {
    ...
    return (
      `${translatedKpi}-ийн гүйцэтгэлийг одоогоор ` +
      `тооцоолох боломжгүй. Хүчинтэй зорилтот утга олдсонгүй.`
    );
  }
  ...
  if (liveMatch) {
    ...
    return (
      `Уурхайн нийт гүйцэтгэлийн чиг хандлага ${translatedTrend}.`
    );
  }
  ...
  if (liveMatch) {
    ...
    return (
      `${translatedKpi}-ийн гүйцэтгэлд үйл ажиллагааны хяналт эхлүүлж, ` +
      `хариуцсан эзэн томилно уу.`
    );
  }
  ...
  if (liveMatch) {
    ...
    return (
      `${translatedKpi}-д нөлөөлж буй гол хязгаарлалтуудыг шалгаж, ` +
      `дараагийн тайлант хугацаанд хянана уу.`
    );
  }
  ...
  if (liveMatch) {
    ...
    return (
      `${translatedKpi}-д одоогоор шууд сөрөг нөлөө ` +
      `тооцоологдоогүй байна.`
    );
  }
  ...
  if (trendMatch) {
    ...
    const metricMap = {
      ...
      "ore performance":
        "Хүдрийн олборлолтын гүйцэтгэл",
 
      "waste movement":
        "Хөрс хуулалтын гүйцэтгэл",
    ...
    return (
      ...
      `${trendMatch[3]} нэгж хувиар ${movement}.`
    );
  }
  ...
  if (trendMatch) {
    ...
    return (
      `Тайлант хугацаанд уурхайн нэгдсэн төлөв ${direction}. ` +
      `Үнэлгээ ${trendMatch[2]}%-иас ${trendMatch[3]}% болж өөрчлөгдөж, ` +
      `нийт өөрчлөлт ${trendMatch[4]} нэгж хувь байна.`
    );
  }
  ...
  const exactMap = {
    ...
    "no material operational driver was identified.":
      "Материаллаг үйл ажиллагааны нөлөөлөгч хүчин зүйл илрээгүй.",
    ...
    "no scenario-specific trend is currently available.":
      "Одоогоор энэ сценарид зориулсан чиг хандлагын мэдээлэл байхгүй байна.",
 
    "no trend summary is currently available.":
      "Одоогоор чиг хандлагын хураангуй мэдээлэл байхгүй байна.",
    ...
    "trend analysis generated from health history":
      "Уурхайн нэгдсэн төлөвийн түүхэн өгөгдөлд үндэслэн чиг хандлагын шинжилгээ үүсгэсэн",
  ...
  const recommendationMap = {
    ...
    "protect critical waste movements, review truck allocation between ore and waste, remove haul-route delays, and confirm dump and dozer capacity for the next shift.":
      "Чухал хөрс тээвэрлэлтийг хамгаалж, хүдэр болон хөрсний чиглэл хоорондын машины хуваарилалтыг шалган, тээврийн замын саатлыг арилгаж, дараагийн ээлжийн буулгалтын талбай болон бульдозерын хүчин чадлыг баталгаажуулна уу.",
    ...
    "protect high-value ore movements, assign available trucks to the most critical ore routes, and review loading-unit and dispatch constraints during the next operating review.":
      "Өндөр үнэ цэнтэй хүдрийн тээвэрлэлтийг хамгаалж, боломжтой машинуудыг хамгийн чухал хүдрийн чиглэлд хуваарилан, дараагийн үйл ажиллагааны хяналтаар ачих төхөөрөмж болон диспетчерийн хязгаарлалтыг шалгана уу.",
    ...
    "prioritize critical equipment work orders, assign recovery owners, protect the next maintenance window, and separate urgent breakdown work from recoverable backlog.":
      "Чухал техникийн ажлын захиалгуудыг нэн тэргүүнд эрэмбэлж, сэргэлтийн хариуцагч томилон, дараагийн засварын цонхыг хамгаалж, яаралтай эвдрэлийн ажлыг сэргээж болох хуримтлагдсан ажлаас тусгаарлана уу.",
    ...
    "protect the current operating rhythm, maintain dispatch discipline, and avoid creating downstream constraints through uncontrolled overproduction.":
      "Одоогийн үйл ажиллагааны хэмнэлийг хамгаалж, диспетчерийн сахилга батыг хадгалан, хяналтгүй хэт үйлдвэрлэлээс шалтгаалсан дараагийн шатны хязгаарлалт үүсгэхээс зайлсхийнэ үү.",
    ...
    "maintain preventive maintenance compliance and protect planned maintenance windows despite strong operational performance.":
      "Үйл ажиллагааны гүйцэтгэл өндөр байсан ч урьдчилан сэргийлэх засварын биелэлтийг хадгалж, төлөвлөсөн засварын цонхыг хамгаална уу.",
 
    "maintain feed consistency, continue monitoring recovery, and avoid pushing throughput beyond sustainable operating limits.":
      "Тэжээлийн тогтвортой байдлыг хадгалж, металл авалтыг үргэлжлүүлэн хянан, боловсруулалтын хүчин чадлыг тогтвортой ажиллагааны хязгаараас хэтрүүлэхээс зайлсхийнэ үү.",
    ...
    "avoid complacency during strong production performance and continue verification of critical controls and field leadership.":
      "Үйлдвэрлэлийн өндөр гүйцэтгэлийн үед тайвшрахгүй байж, ноцтой эрсдэлийн хяналт болон талбайн удирдлагын баталгаажуулалтыг үргэлжлүүлнэ үү.",
...
export function translateDynamicExecutiveHeadline(
  ...
  if (match) {
    return (
      "Удирдлагын нэн даруй анхаарал шаардлагатай: " +
  ...
  if (match) {
    return (
      "Өндөр ач холбогдолтой үйл ажиллагааны хяналт шаардлагатай: " +
      `${translateDynamicInsightTitle(
        match[1],
        t,
      )}.`
...
export function translateDynamicExecutiveActionSource(
  ...
  const sourceMap = {
    ...
    "trend engine": "Чиг хандлагын шинжилгээ",
