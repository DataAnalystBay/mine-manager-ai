...
function ReportHistoryTable({ refreshKey = 0 }) {
  ...
  const formatGeneratedDate = (value) => {
    ...
    return generatedDate.toLocaleString(language === "mn" ? "mn-MN" : "en-US", {
      year: "numeric",
      month: "short",
      day: "2-digit",
      hour: "2-digit",
  ...
  const getStatusLabel = (status) => {
    ...
    return status || t("reports.unknown");
  };
      ...
      >
        ...
        >
          <Box>
            ...
            >
              {t("reports.reportHistoryDescription")}
            </Typography>
          </Box>

          <Tooltip title={t("reports.refreshReportHistory")}>
            <span>
              <IconButton
                onClick={loadHistory}
                disabled={loading}
        ...
        {loading ? (
          ...
          >
            ...
            >
              {t("reports.loadingReportHistory")}
            </Typography>
          </Box>
        ) : history.length === 0 ? (
          <Box
          ...
          >
            ...
            >
              {t("reports.noReportHistoryDescription")}
            </Typography>
          </Box>
        ) : (
          <TableContainer
                    ...
                    <TableCell>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {report.generated_by || t("reports.system")}
                          </Typography>
                        </Tooltip>
