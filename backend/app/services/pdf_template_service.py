...
def draw_page_footer(
    ...
    footer_fonts = ensure_report_pdf_fonts(report_language)

    canvas.setFont(footer_fonts["regular"], 7.5)
    ...
    canvas.drawString(
        ...
        (
            f"{report_name} | "
            f"{localize_report_label('generated_by_mine_manager_ai', report_language)}"
        ),
    )
    ...
    canvas.drawRightString(
        page_width - document.rightMargin,
        footer_y,
        f"{localize_report_label('page', report_language)} {document.page}",
    )
